...
We have $X\geq\epsilonI(X\geq\epsilon)$. Taking expectation on both sides, we get
...
</a>[切比雪夫不等式到底是个什么概念? - 回答作者：姚岑卓](https://chrome.google.com/webstore/detail/eye/epoebkjflhhidcopbenmmilgopgppcfg?hl=en-US)
